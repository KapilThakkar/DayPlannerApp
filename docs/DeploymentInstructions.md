...
2. On __Custom deployment__ pae, select __Subscription__ type.
...
9. Provide the __Postgre SQL Compute Unit__ or leave it as is. [Learn more about Compute Unit](https://docs.microsoft.com/en-us/azure/postgresql/concepts-compute-unit-and-storage#what-are-compute-units)
